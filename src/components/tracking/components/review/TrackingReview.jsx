              ...
              <div className="tracking_review_star d-flex gap-3 align-items-center mb-2">
                ...
                <div className="tracking_review_star_progress">
                  <div className="tracking_review_star_progress_bar position-relative w-100">
                    <span className="position-absolute" style={{ '--progress': '100%' }}></span>
                  </div>
                </div>
              </div>
              <div className="tracking_review_star d-flex gap-3 align-items-center mb-2">
                ...
                <div className="tracking_review_star_progress">
                  <div className="tracking_review_star_progress_bar position-relative w-100">
                    <span className="position-absolute" style={{ '--progress': '80%' }}></span>
                  </div>
                </div>
              </div>
              <div className="tracking_review_star d-flex gap-3 align-items-center mb-2">
                ...
                <div className="tracking_review_star_progress">
                  <div className="tracking_review_star_progress_bar position-relative w-100">
                    <span className="position-absolute" style={{ '--progress': '50%' }}></span>
                  </div>
                </div>
              </div>
              <div className="tracking_review_star d-flex gap-3 align-items-center mb-2">
                ...
                <div className="tracking_review_star_progress">
                  <div className="tracking_review_star_progress_bar position-relative w-100">
                    <span className="position-absolute" style={{ '--progress': '90%' }}></span>
                  </div>
                </div>
              </div>
              <div className="tracking_review_star d-flex gap-3 align-items-center mb-2">
                ...
                <div className="tracking_review_star_progress">
                  <div className="tracking_review_star_progress_bar position-relative w-100">
                    <span className="position-absolute" style={{ '--progress': '5%' }}></span>
                  </div>
                </div>
              </div>
            </div>

      ...
      <div className="card border-0 tour-package">
        <div className="card-body rounded-4 overflow-hidden">
          ...
          <div className="adlt-quantity mt-8">
            <div className="d-flex justify-content-between">
              <div className="heading-adlt">
                <div className="heading-adlt-title fs-sm fw-medium">
                  Adult (age 13+)
                </div>
              ...
              <div className="count-adlt">
                <div className="count-adlt-list d-flex align-items-center gap-2">
                  <div
                    className="package-counter"
                    onClick={() => updateCounter("adults", "decrement")}
                  >
                    <img
                      src={`/images/details/decresing_icon.png`}
                      alt="decreasing_icon"
                    />
                  </div>
                  <span className="count-adlt-number fw-semibold fs-sm">
                    {counter.adults}
                  </span>
                  <div
                    className="package-counter"
                  ...
                  >
                    <img
                      src={`/images/details/incresing_icon.png`}
                      alt="incresing_icon"
                    />
                  </div>
                </div>
            ...
            <div className="d-flex justify-content-between">
              ...
              <div className="count-adlt">
                <div className="count-adlt-list d-flex align-items-center gap-2">
                  <div
                    className="package-counter"
                    onClick={() => updateCounter("child", "decrement")}
                  >
                    <img
                      src={`/images/details/decresing_icon.png`}
                      alt="decreasing_icon"
                  ...
                  <div
                    className="package-counter"
                    onClick={() => updateCounter("child", "increment")}
                  >
                    <img
                      src={`/images/details/incresing_icon.png`}
                      alt="incresing_icon"
          ...
          <div className="tour-package-cta position-relative pt-6 d-flex align-items-center justify-content-between gap-3">
            <button type="button" className="tour-package-btn">
              Add to Plan
            </button>
            <button type="button" className="tour-package-btn booknow">
              Book Now
            </button>
          </div>
        </div>
      ...
      <div className="card border-0 tour-package-location mt-6">
        <div className="card-body rounded-4 pb-8">
          ...
          <div className="d-flex align-items-center mb-2">
            ...
            <p className="tour-package-location-name m-0 fs-xs fw-medium">
              P4C4+JF6, Obhur Al-Shamaliyah, Jeddah
            </p>
          </div>
          ...
          <div className="tour-package-pickup-point mt-4">
            ...
            <div className="d-flex mb-4">
              ...
              <div>
                <p className="tour-package-location-name mb-1 fs-xs fw-medium">
                  Hyaat Hotel, Jeddah
                </p>
                <p className="tour-package-location-name text-clamp m-0 fs-xs fw-medium text-black">
                  Pickup and drop-off services are available from hotels in the
                  Jeddah...
                </p>
              </div>
            </div>

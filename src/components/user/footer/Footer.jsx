          ...
          <div className="container-footer">
            <div className="row">
              <div className="col-lg-3 col-sm-12">
                <div>
                  <a className="d-inline-block mb-4" href="index.html">
                    <img alt="Travila" src="https://travila-demos.vercel.app/assets/imgs/template/logo-footer.svg" />
                  </a>
                  <div className="box-info-contact">
                    <p className="text-md color-white footer-info">Dive into local recommendations for a truly authentic experience.</p>
                  </div>
                  <div className="box-need-help"> 
                    <p className="need-help text-md-medium color-white">Need help? Call us</p>
                    <a className="heading-6 phone-support" href="tel:1-800-222-8888">1-800-222-8888</a>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3"> 
                ...
                <div className="d-flex align-items-center">
                  <form className="form-newsletter" action="#"> 
                    <input className="form-control w-100 mb-3" type="text" placeholder="Enter your email" />
                    <input className="btn btn-brand-secondary" type="submit" value="Subscribe" />
                  </form>
                </div>
              </div>
            </div>
            <div className="footer-bottom">
              <div className="row align-items-center">
                <div className="col-md-6 text-md-start text-center">
                  <p className="text-sm color-white mb-0">© 2024 Travila Inc. All rights reserved.</p>
                </div>
                <div className="col-md-6 text-md-end text-center">
                  <div className="d-flex align-items-center justify-content-center justify-content-md-end box-socials-footer-cover">
                    <p className="text-lg-bold color-white d-inline-block mb-0 me-4">Follow us</p>
